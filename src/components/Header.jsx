        ...
        <div className="mx-auto px-6 xl:px-12 flex items-center justify-between">
          ...
          <nav className="hidden lg:block">
            <ul className="flex items-center gap-6 list-none m-0 p-0">
              {NAV_LINKS.map(item => {
                const isPlacement = item.label.toLowerCase() === "placement";
                return (
                  <li key={item.label}>
                    <a 
                      href={item.href} 
                      className={`nav-link text-[14px] uppercase tracking-[0.14em] cursor-pointer whitespace-nowrap font-extrabold transition-all duration-500 text-decoration-none pb-1 ${
                        isPlacement 
                          ? navActive 
                            ? "text-[#1B4D8E] border-b-2 border-[#1B4D8E]" 
                            : "text-[#E8BD63] border-b-2 border-[#E8BD63]"
                          : navActive 
              ...
              return (
                <a 
                  ...
                  className={`block py-3.5 text-[15px] font-extrabold uppercase tracking-[0.14em] hover:text-primary hover:bg-soft/50 rounded-lg px-3 transition-all duration-500 transform text-decoration-none ${
                    isPlacement 
                      ? "text-[#1B4D8E] border-l-4 border-[#1B4D8E] pl-4 bg-slate-50" 
                      : "text-[#3E3A36]"
                  } ${
